...
marathon and conference events at MIT, using MIMIC-II, a large, open
database of intensive care unit data. Assisted my data marathon team
with SQL data pull, predictive modeling, and clinical expertise.
