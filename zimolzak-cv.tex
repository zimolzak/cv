...
using Fourier spectral analysis. Present at and attend regular laboratory
...
10/15/2011\ndash{}present. Diagnose and treat minor acute medical problems,
...
\textbf{Computer skills.} Two years experience with SAS and R
statistical programming, SQL, and Git source code management. Ten
years experience with the Perl programming language, Unix shell
commands and shell programming, \LaTeX, and GNU Emacs. Advanced
experience with Microsoft Windows, Word, Excel, and PowerPoint, and
with Macintosh OS X. Intermediate experience with Apple Final Cut
video editing, HTML4, CSS, and Adobe Photoshop. \emph{Electronic
