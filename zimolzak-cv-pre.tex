...
staff and students. Supervisors: Hardeep Singh, Chris Amos, Andrew Caruso, Lindsey Gay.

% FIXME - sql python ML SVM ANN CNN RNN
...
association and other studies, still in use as of 2024. I personally exported and encrypted
data from this system to the mirror system at Oak Ridge National
...
and as principal investigator on a study of genomic predictors
...
unit data covering 8 years. Collaborated on writing and
submitting a R25 grant. Professor: Leo Celi.
...
adherence. Used \textbf{SAS software and multivariable logistic
  regression} to analyze $\sim$ 300M claims from 61M individuals. I designed and
wrote all code to perform the analysis (2,000 lines in the final
project). Pilot projects using multivariable adaptive regression
...
Health Program in Clinical Effectiveness. Professor: Kenneth Mandl. Program director: Alexa McCray.

\textbf{Urgent care physician,} Harvard Vanguard Medical Associates,
10/15/2011\ndash{}6/30/2018. Diagnose and treat outpatients with acute
medical problems, e.g.\ infections,
...
internal medicine. Attended on
inpatient \& outpatient general medicine in university and VA
hospitals. Accepted transfers, supervised and improved patient
handoffs. Precepted medical students, ran morbidity/mortality and
clinicopathologic conferences, and $\sim 100$ resident
report conferences. Interviewed and helped select residency program
applicants. Program director: Miguel
Paniagua.

\textbf{Research elective,} 2/2007\ndash4/2007. Association rule mining
on a database of 12,000 outpatients and 40,000 diagnoses.
...
\textbf{Inquiry Project}. 2023\ndash{}present. Funded as faculty for a
new curriculum component and course block, designed to promote
...
\textbf{Jenny Sloane} (informal). 2022\ndash{}present. Postdoctoral fellow in
...
% Jeanette Girard. Senior endo fellow. 2023+
...
\textbf{Clinical Informatics} board-certified 1/1/2014 (ABPM), completed 2023
...
in Medicine, 10/2023.\\
\textbf{GME Poster award,} MEDVAMC Education Day, 3/2023. Title:
``Increasing Usage of an Inpatient Insulin Order Set.''\\
\textbf{Poster award,} BCM House Staff Research Symposium, 2023. Title:
``Increasing Usage of an Inpatient Insulin Order Set.''\\
\textbf{Best of the best oral abstracts,} Society to Improve Diagnosis
...
\textbf{Tower Guard,} 1999\ndash{}2000. Service-oriented academic honor
...
Inform Assoc. 2023 Mar 7:ocad030. Epub ahead of print.
...
Zimolzak AJ, Singh H, Davila J. \textbf{Application of a Digital
  Quality Measure for Cancer Diagnosis in Epic Cosmos.} Society
to Improve Diagnosis in Medicine conference (Best of the best oral
presentation). Cleveland, 10/2023.
...
\textbf{Internal grant review,} IQuESt. 2023\ndash{}present. Reviewed
and commented on 1 faculty grant, 2 career development awards.\\
