...
%% \$1,185,000.
% need to double check dates, FY22 seems odd. Tierney says yes, it
% starts approx FY23, aka Oct 2022.
...
%% INSERT DATES. GBMF NNNN. Amount: \$500,000 for 18 months.

% fixme - WAIT
%% Dx Center Excellence, other (TG, PI2, PI3).

% fixme - WAIT
%% Advisor: \textbf{Identifying current clinical care processes to
%% reduce delays in colorectal cancer diagnoses.} DATES. SOCIETY/FOUNDATION.
%% AMOUNT. DK, CRQS.
