...
%   multiple DEX 2025 presentations (posters) Rachel, viral.
%   DDW presentation Khalaf et al
...
% FIXME - add the following
%   QIPS poster Khalaf
%   add to cv: the invited VA Method Advisory Council talk
%   data sci seminar fr 12/18 to CV
%   data sci seminar that was about cosmos
%   Love Data Week talk to CV
