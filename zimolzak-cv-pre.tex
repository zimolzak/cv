...
and clinical trials matching. I work as a \textbf{teaching attending}
on the VA inpatient medicine service, supervising house staff and
students. Supervisors: Hardeep Singh, Chris Amos, Andrew Caruso,
Lindsey Gay.
...
association and other studies, still in use as of 2024. I personally
exported and encrypted data from this system to the mirror system at
Oak Ridge National Laboratory (2018). I collaborated on writing and
submission of a U01 grant. I served as \textbf{co-program-director} of
...
adherence. Used \textbf{SAS software and multivariable logistic
  regression} to analyze $\sim$ 300M claims from 61M individuals. I
designed and wrote all code to perform the analysis (2,000 lines in
the final project). Pilot projects using multivariable adaptive
...
Title: ``Increasing Usage of an Inpatient Insulin Order Set.''\\
\textbf{Best of the best oral abstracts,} Society to Improve Diagnosis
